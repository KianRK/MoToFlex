...
public:
	...
	*/
	 ...
	 */
	double getStepLength(double speed);
...
protected:
	 ...
	 */
	inline unsigned int getPhaseLength(double ratio, double stepDur);
	...
	void applySpeed(bool x, bool y, bool r);
