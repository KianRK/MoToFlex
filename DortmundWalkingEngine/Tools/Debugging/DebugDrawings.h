...
public:
  ...
  ColorRGBA(ColorClasses::Color colorClass)
  {
    ...
    case ColorClasses::red:         r = 255; g = 0; b = 0;     break;
	  ...
	  case ColorClasses::gray:        r = 105; g = 105; b = 105; break;
	  case ColorClasses::yellowOrange: r = 218; g = 165; b = 32; break;
	  case ColorClasses::redOrange:	  r = 255; g = 69; b = 0;    break;
	  case ColorClasses::darkGreen:	  r = 0; g = 100; b = 0;     break;
	  case ColorClasses::blackBlue:	  r = 0; g = 0; b = 139;     break;
	  case ColorClasses::blueGreen:	  r = 32; g = 178; b = 170;  break;
	  case ColorClasses::yellowWhite:	r = 255; g = 255; b = 224; break;
