...
void ActionBehavior::execute()
{
  ...
  /* debugLog Function logs current action */   
	DebugSymbolsLog::print("#O#");	
	DebugSymbolsLog::print(getBehavior()->n);	

	DebugSymbolsLog::print("P");
	getBehavior()->parameters->logAllParam();
