...
static const char* getMessageIDName(MessageID id)
{
  ...
  case idGoalPerceptBH: return "GoalPerceptBH";
  ...
  case idRobotMap: return "RobotMap";
  case idGroundTruthRobotMap: return "GroundTruthRobotMap";
  case idLocalBallModel: return "LocalBallModel";
