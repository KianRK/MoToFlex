...
/*	  int r = (int)(Y + 1.4021 * (Cr - 128)),
  ...
  static void fromRGBToYCbCr(unsigned char R,
                             ...
                             unsigned char& Cr)
  {
    //int y  =       (int)( 0.2990 * R + 0.5870 * G + 0.1140 * B), // Y
    //    cb = 127 + (int)(-0.1687 * R - 0.3313 * G + 0.5000 * B), // U
    //    cr = 127 + (int)( 0.5000 * R - 0.4187 * G - 0.0813 * B); // V
    int y  = (         306 * R + 601 * G + 117 * B) >> 10, // Y
        cb = (130560 - 172 * R - 339 * G + 512 * B) >> 10, // U
        cr = (130560 + 512 * R - 429 * G -  83 * B) >> 10; // V
