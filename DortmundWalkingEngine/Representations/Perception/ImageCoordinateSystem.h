...
public:
  ...
  */
  ...
  Vector2<double> fromHorizonBasedD(const Vector2<double>& horizonBasedCoords) const
  {
    return rotation * horizonBasedCoords + origin;
  }
  ...
  */
  Vector2<double> toCorrected(const Vector2<double>& imageCoords) const
  {
  ...
  {
    return toCorrected(Vector2<double>(imageCoords.x,imageCoords.y));
  }
  ...
  */
  ...
  /**
  * Returns the horizon as a Geometry::Line.
  * @return The horizon.
  */
  Geometry::Line getHorizonAsLine() const
  {
    return Geometry::Line(origin, rotation.c[0]);
  }
