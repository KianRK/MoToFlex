...
void RobotPoseAfterPreview::draw()
{
  ...
  LINE("representation:RobotPoseAfterPreview", translation.x, translation.y, dirVec.x, dirVec.y, 
    20, Drawings::ps_solid, transparentWhite);
  POLYGON("representation:RobotPoseAfterPreview", 4, bodyPoints, 20, Drawings::ps_solid, 
    ownTeamColorForDrawing, Drawings::bs_solid, transparentWhite);
  CIRCLE("representation:RobotPoseAfterPreview", translation.x, translation.y, 42, 1, 
    Drawings::ps_solid, ownTeamColorForDrawing, Drawings::bs_solid, ownTeamColorForDrawing);
