...
public:
  ...
  void draw() 
  {
    ...
    COMPLEX_DRAWING("representation:ObstacleModelAfterPreview",
    {
...
class ObstacleModelAfterPreview : public ObstacleModel
{
public:
  /** Function for drawing */
  void draw() 
  {
    DECLARE_DEBUG_DRAWING("representation:ObstacleModelAfterPreview", "drawingOnField"); 
    COMPLEX_DRAWING("representation:ObstacleModelAfterPreview",
    {
      Vector2<double> left(distanceToLeftObstacle,0);
      Vector2<double> centerLeft(distanceToCenterLeftObstacle,0);
      ...
      a+=baseLeft;
      b+=baseLeft;
      LINE("representation:ObstacleModelAfterPreview", baseLeft.x, baseLeft.y, a.x, a.y, 
        30, Drawings::ps_solid, ColorClasses::robotBlue);
      LINE("representation:ObstacleModelAfterPreview", baseLeft.x, baseLeft.y, b.x, b.y, 
        30, Drawings::ps_solid, ColorClasses::robotBlue);
      LINE("representation:ObstacleModelAfterPreview", b.x, b.y, a.x, a.y, 
        30, Drawings::ps_solid, ColorClasses::robotBlue);
      // Center Left sector:
      a = centerLeft;
      b = centerLeft;
      ...
      a+=baseRight;
      b+=baseRight;
      LINE("representation:ObstacleModelAfterPreview", baseRight.x, baseRight.y, a.x, a.y, 
        30, Drawings::ps_solid, ColorClasses::robotBlue);
      LINE("representation:ObstacleModelAfterPreview", baseRight.x, baseRight.y, b.x, b.y, 
        30, Drawings::ps_solid, ColorClasses::robotBlue);
      LINE("representation:ObstacleModelAfterPreview", b.x, b.y, a.x, a.y, 
        30, Drawings::ps_solid, ColorClasses::robotBlue);
      // Right sector:
