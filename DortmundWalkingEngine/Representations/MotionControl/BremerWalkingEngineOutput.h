...
#ifndef __BremerWalkingEngineOutput_H__
#define __BremerWalkingEngineOutput_H__

#include "Representations/Infrastructure/JointData.h"
#include "Tools/Math/Pose2D.h"

/**
* @class BremerWalkingEnigeOutput
* A class that represents the output of the bremer walking engine.
*/
class BremerWalkingEngineOutput : public JointRequest
{
public:
  ...
  * Default constructor.
  */
  BremerWalkingEngineOutput() : isLeavingPossible(true), positionInWalkCycle(0), 
