 ...
 * This virtual class defines the interface
...
public:
	 ...
	 * \param numOfAngles
	 */
	virtual void getAngles(float angles[], int numOfAngles, Robot &robot) = 0;

	/**
	 * This function sets the path to a custom config/angle file
	 * \param path The path to the file.
	 */
	virtual void setSettingsPath(string path) {};
};